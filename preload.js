...
contextBridge.exposeInMainWorld('api', {
  ...
  classifier: {
    ...
    createObject:      (mref,n,c)          => inv('classifier:createObject', mref,n,c),
    updateObject:      (id,n,c)            => inv('classifier:updateObject', id,n,c),
  ...
  narrator: {
    ...
    createTalk:        (did,sp,tx)      => inv('narrator:createTalk', did,sp,tx),
