...
### Plugins — เดิม Github Sandboxed Extensions (2026-07-30, เปลี่ยนชื่อ + ติดตั้งจากลิงก์ 2026-08-06, panel API 2026-08-06, loopback net 2026-08-06, dependencies 2026-08-12)
...
- **`dependencies` (v4.8.0)** — manifest ประกาศปลั๊กอินอื่นที่ต้องมีคู่กันได้
  (repo URL แบบเดียวกับช่องติดตั้ง ไม่เกิน 5 รายการ) พรีวิวโชว์บล็อก
  "ติดตั้งมาด้วย" แยกต่างหาก และกดยืนยันครั้งเดียวติดตั้งทั้ง dependency (ข้าม
  ตัวที่มีอยู่แล้ว) ก่อนปลั๊กอินหลัก — **ไม่ใช่** runtime API ให้ปลั๊กอินสั่ง
  ติดตั้งกันเองได้ ยังผ่าน install flow เดิมทั้งหมด ลึกแค่ชั้นเดียว (ไม่ตาม
  `dependencies` ของ dependency ต่อ) ตัวอย่างจริง: DraconDex-Plugin-Claude/
  -Ollama/-Codex ประกาศ DraconDex-Plugin-Native ("AI Native" — ปลั๊กอินคลัง
  `catalog.json` สาธารณะของฟีเจอร์/เครื่องมือแอป) เป็น dependency ร่วมกัน ดู
  PLUGINS.md §1.8
