...
- [x] เพิ่มfeature
    ...
    - [x] 2.Artisan ->เมื่อผู้ใช้เลือก templateได้แล้ว จะแสดงModalเป็นstep เพื่อให้ผู้ใช้ตั้งค่า module แต่ละส่วนเอง
    ...
    - [x] 3.icon import -> เพิ่มระบบให้ผู้ใช้สามารถCropรูปให้เป็นวงกลม และจะแสดงผลภาพนั้นเป็นiconได้ โดยสามารถเลือกimportรูปได้เอง
- [x] แก้ไขfeature
    - [x] 1.Nav-sidebarไม่ต้องมีmodule rail ให้เปลียนเป็นระบบpin moduleแทน
    - [x] 2.Artisan -> ไม่ต้องมีmoduleเต็ม, ไม่ใช้อีกต่อไป
    - [x] 3.icon popup -> ขยายpopup แสดงผลครบถ้วน หรือไม่ก็ปรับ div ส่วน icon collection ให้มีvertical slider ทำให้สามารถเลื่อนลงในแนวตั้งได้
    - [x] 4.icon popup -> ย้ายPreviewขึ้นด้านบนของoverlay และเอาSearch box ออก
part 3
- [ ] แก้ไขBuilder
