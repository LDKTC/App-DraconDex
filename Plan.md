...
- [ ] 4.สามารถตั้งเลขบท และชื่อด้านหน้าเองได้เช่น ตอนที่1.5 หรือ โน้ตตัวที่ 3/4 โดยระบบสร้างอัตโนมัติจะสร้างเรียงเป็น +1 จากเลขจำนวนเต็มด้านหน้าทศนิยมเสมอ เช่น 1.5 ตอนต่อไปคือ 2
#### Chat"Scribe" Module
