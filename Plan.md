...
### Process 1
#### part 1 : nexus
- [ ] module analys text ที่แสดง module หลักบนnexus, เปลี่ยนการแสดง major module แบบ "2" ที่เป็นเลขธรรมดา เป็น "2:144" โดยเลขด้านหลังเป็นจำนวนmodulทั้งหมดโดยรวม child major module ทั้งหมดในroot ของ nexusนั้น
#### part 2 : setting
