...
const L = {
  en: {
    ...
    artV3Card:'v3 structure (Nexus nest)', artV3CardD:'Creates a Manager Major with this target\'s pre-filled Minors in the Nexus nest', artStartTemplate:'Start from template', artNoTemplate:'No template', artLegacySection:'Legacy modules',
  ...
  ja: {
    ...
    artV3Card:'v3 構成 (Nexus nest)', artV3CardD:'Nexus nest に Manager Major とプリセット Minor 一式を作成', artStartTemplate:'テンプレートから開始', artNoTemplate:'テンプレートなし', artLegacySection:'旧モジュール',
  ...
  ko: {
    ...
    artV3Card:'v3 구조 (Nexus nest)', artV3CardD:'Nexus nest에 Manager Major와 사전 구성 Minor 세트를 생성', artStartTemplate:'템플릿에서 시작', artNoTemplate:'템플릿 없음', artLegacySection:'레거시 모듈',
  ...
  th: {
    ...
    artV3Card:'โครงสร้าง v3 (Nexus nest)', artV3CardD:'สร้าง Major แบบ Manager พร้อม Minor ชุดสำเร็จของหมวดนี้ลงใน Nexus nest', artStartTemplate:'เริ่มจาก template', artNoTemplate:'ไม่ใช้ template', artLegacySection:'โมดูลเดิม',
  ...
  zh: {
    ...
    artV3Card:'v3 结构 (Nexus nest)', artV3CardD:'在 Nexus nest 中创建 Manager Major 及该类型的预置 Minor 集', artStartTemplate:'从模板开始', artNoTemplate:'不用模板', artLegacySection:'旧模块',
  ...
  vi: {
    ...
    artV3Card:'Cấu trúc v3 (Nexus nest)', artV3CardD:'Tạo Major kiểu Manager cùng bộ Minor dựng sẵn trong Nexus nest', artStartTemplate:'Bắt đầu từ template', artNoTemplate:'Không dùng template', artLegacySection:'Module cũ',
  ...
  id: {
    ...
    artV3Card:'Struktur v3 (Nexus nest)', artV3CardD:'Membuat Major Manager dengan set Minor siap pakai di Nexus nest', artStartTemplate:'Mulai dari template', artNoTemplate:'Tanpa template', artLegacySection:'Modul lama',
  ...
  es: {
    ...
    artV3Card:'Estructura v3 (Nexus nest)', artV3CardD:'Crea un Major Manager con sus Minors predefinidos en el Nexus nest', artStartTemplate:'Empezar desde plantilla', artNoTemplate:'Sin plantilla', artLegacySection:'Módulos antiguos',
  ...
  pt: {
    ...
    artV3Card:'Estrutura v3 (Nexus nest)', artV3CardD:'Cria um Major Manager com os Minors pré-preenchidos no Nexus nest', artStartTemplate:'Começar de um template', artNoTemplate:'Sem template', artLegacySection:'Módulos antigos',
  ...
  fr: {
    ...
    artV3Card:'Structure v3 (Nexus nest)', artV3CardD:'Crée un Major Manager avec ses Minors préremplis dans le Nexus nest', artStartTemplate:'Partir d\'un modèle', artNoTemplate:'Sans modèle', artLegacySection:'Modules hérités',
  ...
  de: {
    ...
    artV3Card:'v3-Struktur (Nexus nest)', artV3CardD:'Erzeugt einen Manager-Major mit vorbefüllten Minors im Nexus nest', artStartTemplate:'Aus Vorlage starten', artNoTemplate:'Ohne Vorlage', artLegacySection:'Alt-Module',
  ...
  ru: {
    ...
    artV3Card:'Структура v3 (Nexus nest)', artV3CardD:'Создаёт Major-Manager с готовым набором Minor в Nexus nest', artStartTemplate:'Начать с шаблона', artNoTemplate:'Без шаблона', artLegacySection:'Старые модули',
  ...
  it: {
    ...
    artV3Card:'Struttura v3 (Nexus nest)', artV3CardD:'Crea un Major Manager con i Minor precompilati nel Nexus nest', artStartTemplate:'Parti da template', artNoTemplate:'Senza template', artLegacySection:'Moduli legacy',
  ...
  nl: {
    ...
    artV3Card:'v3-structuur (Nexus nest)', artV3CardD:'Maakt een Manager-Major met vooraf gevulde Minors in de Nexus nest', artStartTemplate:'Start vanuit sjabloon', artNoTemplate:'Geen sjabloon', artLegacySection:'Oude modules',
  ...
  pl: {
    ...
    artV3Card:'Struktura v3 (Nexus nest)', artV3CardD:'Tworzy Majora typu Manager z gotowym zestawem Minorów w Nexus nest', artStartTemplate:'Zacznij od szablonu', artNoTemplate:'Bez szablonu', artLegacySection:'Stare moduły',
  ...
  uk: {
    ...
    artV3Card:'Структура v3 (Nexus nest)', artV3CardD:'Створює Major-Manager з готовим набором Minor у Nexus nest', artStartTemplate:'Почати з шаблону', artNoTemplate:'Без шаблону', artLegacySection:'Старі модулі',
  ...
  tr: {
    ...
    artV3Card:'v3 yapısı (Nexus nest)', artV3CardD:'Nexus nest içinde hazır Minor setiyle bir Manager Major oluşturur', artStartTemplate:'Şablondan başla', artNoTemplate:'Şablonsuz', artLegacySection:'Eski modüller',
  ...
  qd: {
    ...
    artV3Card:'v3 structoure (Nexus neste)', artV3CardD:'Createth a Manager Major wyth pre-fylled Minors in the Nexus neste', artStartTemplate:'Starte from template', artNoTemplate:'No template', artLegacySection:'Legacie modules',
