...
const L = {
  en: {
    ...
    editFilter:'Edit filter', filterAll:'Everything', viewerHint:'Shows the saved filter\'s results · updates automatically when source data changes', noFilterResults:'No items match the filter', timeLabel:'Time', groupBy:'Group by', addRelation:'Add relation', relationLabel:'Relation label', relFrom:'From', relTo:'To', recentUsed:'Recently used',
    ...
    moduleInspector:'Module Inspector', moduleDetailSpec:'Module detail spec', moduleAttribute:'Module attribute', toggleInspector:'Toggle Module Inspector', resizePanel:'Drag to resize', resizePageView:'Drag to resize page view', splitPane:'Split pane', closePane:'Close pane', moveToMainWindow:'Move to main window', tabMoveWrongVault:'Tab belongs to a different vault',
  ...
  ja: {
    ...
    editFilter:'フィルタを編集', filterAll:'すべて', viewerHint:'保存フィルタの結果を表示 · 元データ変更時に自動更新', noFilterResults:'フィルタに一致する項目なし', timeLabel:'時間', groupBy:'グループ化', addRelation:'関係を追加', relationLabel:'関係ラベル', relFrom:'From', relTo:'To', recentUsed:'最近使用',
    ...
    moduleInspector:'モジュールインスペクター', moduleDetailSpec:'モジュール詳細仕様', moduleAttribute:'モジュール属性', toggleInspector:'モジュールインスペクターの表示切替', resizePanel:'ドラッグしてリサイズ', resizePageView:'ドラッグしてページ表示をリサイズ', splitPane:'ペインを分割', closePane:'ペインを閉じる', moveToMainWindow:'メインウィンドウに移動', tabMoveWrongVault:'タブは別のVaultのものです',
  ...
  ko: {
    ...
    editFilter:'필터 편집', filterAll:'전체', viewerHint:'저장된 필터 결과 표시 · 원본 데이터 변경 시 자동 갱신', noFilterResults:'필터와 일치하는 항목 없음', timeLabel:'시간', groupBy:'그룹 기준', addRelation:'관계 추가', relationLabel:'관계 라벨', relFrom:'From', relTo:'To', recentUsed:'최근 사용',
    ...
    moduleInspector:'모듈 인스펙터', moduleDetailSpec:'모듈 상세 사양', moduleAttribute:'모듈 속성', toggleInspector:'모듈 인스펙터 전환', resizePanel:'드래그하여 크기 조절', resizePageView:'드래그하여 페이지 보기 크기 조절', splitPane:'창 분할', closePane:'창 닫기', moveToMainWindow:'메인 창으로 이동', tabMoveWrongVault:'탭이 다른 볼트에 속해 있습니다',
  ...
  th: {
    ...
    moduleInspector:'Module Inspector', moduleDetailSpec:'Module detail spec', moduleAttribute:'Module attribute', toggleInspector:'เปิด/ปิด Module Inspector', resizePanel:'ลากเพื่อปรับขนาด', resizePageView:'ลากเพื่อปรับขนาดมุมมองหน้า', splitPane:'แบ่งpane', closePane:'ปิดpane', moveToMainWindow:'ย้ายไปหน้าต่างหลัก', tabMoveWrongVault:'แท็บนี้อยู่คนละ Vault',
  ...
  zh: {
    ...
    editFilter:'编辑筛选器', filterAll:'全部', viewerHint:'显示已保存筛选器的结果 · 源数据变化时自动更新', noFilterResults:'没有符合筛选器的项目', timeLabel:'时间', groupBy:'分组方式', addRelation:'添加关系', relationLabel:'关系标签', relFrom:'从', relTo:'到', recentUsed:'最近使用',
    ...
    moduleInspector:'模块检查器', moduleDetailSpec:'模块详情规格', moduleAttribute:'模块属性', toggleInspector:'切换模块检查器', resizePanel:'拖动以调整大小', resizePageView:'拖动以调整页面视图大小', splitPane:'拆分窗格', closePane:'关闭窗格', moveToMainWindow:'移到主窗口', tabMoveWrongVault:'标签属于不同的库',
  ...
  vi: {
    ...
    editFilter:'Sửa bộ lọc', filterAll:'Tất cả', viewerHint:'Hiển thị kết quả bộ lọc đã lưu · tự cập nhật khi dữ liệu nguồn thay đổi', noFilterResults:'Không có mục nào khớp bộ lọc', timeLabel:'Thời gian', groupBy:'Nhóm theo', addRelation:'Thêm quan hệ', relationLabel:'Nhãn quan hệ', relFrom:'Từ', relTo:'Đến', recentUsed:'Dùng gần đây',
  ...
  it: {
    ...
    editFilter:'Modifica filtro', filterAll:'Tutto', viewerHint:'Mostra i risultati del filtro salvato · si aggiorna quando i dati cambiano', noFilterResults:'Nessun elemento corrisponde', timeLabel:'Tempo', groupBy:'Raggruppa per', addRelation:'Aggiungi relazione', relationLabel:'Etichetta relazione', relFrom:'Da', relTo:'A', recentUsed:'Usati di recente',
  ...
  nl: {
    ...
    moduleInspector:'Module-inspector', moduleDetailSpec:'Module detailspecificatie', moduleAttribute:'Module-attribuut', toggleInspector:'Module-inspector wisselen', resizePanel:'Sleep om te vergroten/verkleinen', resizePageView:'Sleep om de paginaweergave te vergroten/verkleinen', splitPane:'Deelvenster splitsen', closePane:'Deelvenster sluiten', moveToMainWindow:'Verplaats naar hoofdvenster', tabMoveWrongVault:'Tabblad hoort bij een andere vault',
  ...
  qd: {
    ...
    editFilter:'Edite fyltre', filterAll:'Everythinge', viewerHint:'Sheweth the saved fyltre\'s resultes · updateth when sourse data chaunge', noFilterResults:'No thynges matche the fyltre', timeLabel:'Tyme', groupBy:'Groupe by', addRelation:'Adde relatioun', relationLabel:'Relatioun laybel', relFrom:'From', relTo:'To', recentUsed:'Recyntlie Usyd',
    ...
    moduleInspector:'Modyul Skryha', moduleDetailSpec:'Modyul Detayl Speka', moduleAttribute:'Modyul Aspektyx', toggleInspector:'Swyvv thy Modyul Skryha', resizePanel:'Dryvv tu resyza', resizePageView:'Dryvv tu resyza thy Payge Vyu', splitPane:'Klyvv thy Payne', closePane:'Klosa thy Payne', moveToMainWindow:'Vorqu tu Meyn Vorqu', tabMoveWrongVault:'Tabyx eryx Othyr Vaska',
