...
const L = {
  en: {
    ...
    moduleInspector:'Module Inspector', moduleDetailSpec:'Module detail spec', moduleAttribute:'Module attribute', toggleInspector:'Toggle Module Inspector', resizePanel:'Drag to resize', splitPane:'Split pane', closePane:'Close pane', moveToMainWindow:'Move to main window', tabMoveWrongVault:'Tab belongs to a different vault',
  ...
  ja: {
    ...
    moduleInspector:'モジュールインスペクター', moduleDetailSpec:'モジュール詳細仕様', moduleAttribute:'モジュール属性', toggleInspector:'モジュールインスペクターの表示切替', resizePanel:'ドラッグしてリサイズ', splitPane:'ペインを分割', closePane:'ペインを閉じる', moveToMainWindow:'メインウィンドウに移動', tabMoveWrongVault:'タブは別のVaultのものです',
  ...
  ko: {
    ...
    moduleInspector:'모듈 인스펙터', moduleDetailSpec:'모듈 상세 사양', moduleAttribute:'모듈 속성', toggleInspector:'모듈 인스펙터 전환', resizePanel:'드래그하여 크기 조절', splitPane:'창 분할', closePane:'창 닫기', moveToMainWindow:'메인 창으로 이동', tabMoveWrongVault:'탭이 다른 볼트에 속해 있습니다',
  ...
  th: {
    ...
    moduleInspector:'Module Inspector', moduleDetailSpec:'Module detail spec', moduleAttribute:'Module attribute', toggleInspector:'เปิด/ปิด Module Inspector', resizePanel:'ลากเพื่อปรับขนาด', splitPane:'แบ่งpane', closePane:'ปิดpane', moveToMainWindow:'ย้ายไปหน้าต่างหลัก', tabMoveWrongVault:'แท็บนี้อยู่คนละ Vault',
  ...
  zh: {
    ...
    moduleInspector:'模块检查器', moduleDetailSpec:'模块详情规格', moduleAttribute:'模块属性', toggleInspector:'切换模块检查器', resizePanel:'拖动以调整大小', splitPane:'拆分窗格', closePane:'关闭窗格', moveToMainWindow:'移到主窗口', tabMoveWrongVault:'标签属于不同的库',
  ...
  vi: {
    ...
    moduleInspector:'Module Inspector', moduleDetailSpec:'Chi tiết module', moduleAttribute:'Thuộc tính module', toggleInspector:'Bật/tắt Module Inspector', resizePanel:'Kéo để đổi kích thước', splitPane:'Chia khung', closePane:'Đóng khung', moveToMainWindow:'Chuyển về cửa sổ chính', tabMoveWrongVault:'Tab thuộc kho khác',
  ...
  ru: {
    ...
    moduleInspector:'Инспектор модуля', moduleDetailSpec:'Спецификация модуля', moduleAttribute:'Атрибут модуля', toggleInspector:'Показать/скрыть инспектор модуля', resizePanel:'Перетащите для изменения размера', splitPane:'Разделить панель', closePane:'Закрыть панель', moveToMainWindow:'Переместить в главное окно', tabMoveWrongVault:'Вкладка принадлежит другому хранилищу',
  ...
  it: {
    ...
    moduleInspector:'Ispettore Modulo', moduleDetailSpec:'Specifica dettaglio modulo', moduleAttribute:'Attributo modulo', toggleInspector:"Attiva/disattiva l'Ispettore Modulo", resizePanel:'Trascina per ridimensionare', splitPane:'Dividi riquadro', closePane:'Chiudi riquadro', moveToMainWindow:'Sposta nella finestra principale', tabMoveWrongVault:'La scheda appartiene a un altro vault',
  ...
  nl: {
    ...
    moduleInspector:'Module-inspector', moduleDetailSpec:'Module detailspecificatie', moduleAttribute:'Module-attribuut', toggleInspector:'Module-inspector wisselen', resizePanel:'Sleep om te vergroten/verkleinen', splitPane:'Deelvenster splitsen', closePane:'Deelvenster sluiten', moveToMainWindow:'Verplaats naar hoofdvenster', tabMoveWrongVault:'Tabblad hoort bij een andere vault',
  ...
  pl: {
    ...
    moduleInspector:'Inspektor modułu', moduleDetailSpec:'Specyfikacja szczegółów modułu', moduleAttribute:'Atrybut modułu', toggleInspector:'Przełącz inspektor modułu', resizePanel:'Przeciągnij, aby zmienić rozmiar', splitPane:'Podziel panel', closePane:'Zamknij panel', moveToMainWindow:'Przenieś do głównego okna', tabMoveWrongVault:'Karta należy do innego magazynu',
  ...
  qd: {
    ...
    moduleInspector:'Modyul Skryha', moduleDetailSpec:'Modyul Detayl Speka', moduleAttribute:'Modyul Aspektyx', toggleInspector:'Swyvv thy Modyul Skryha', resizePanel:'Dryvv tu resyza', splitPane:'Klyvv thy Payne', closePane:'Klosa thy Payne', moveToMainWindow:'Vorqu tu Meyn Vorqu', tabMoveWrongVault:'Tabyx eryx Othyr Vaska',
