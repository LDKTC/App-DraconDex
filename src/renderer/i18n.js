...
const L = {
  en: {
    ...
    writeBooks:'Books', writeBookNew:'New Book', writeChapters:'Chapters', writeChapterNew:'New Chapter', chapterLabel:'Chapter Label', exportDoc:'Export as .doc',
    ...
    addDialogue:'Add Dialogue', conversation:'Conversation', addTalk:'Add line', speaker:'Speaker', edgeTool:'Connect route', edgeLabel:'Route label', narratorPanHint:'Right-drag = pan · Ctrl+Scroll = zoom · drag nodes to arrange', narratorPickTarget:'Click the target node', narratorLinkFilter:'Link Filter', description:'Description',
  ...
  ja: {
    ...
    writeBooks:'ブック', writeBookNew:'新規ブック', writeChapters:'チャプター', writeChapterNew:'新規チャプター', chapterLabel:'チャプター番号', exportDoc:'.docとしてエクスポート',
    ...
    addDialogue:'ダイアログを追加', conversation:'会話', addTalk:'セリフを追加', speaker:'話者', edgeTool:'ルートを接続', edgeLabel:'ルートラベル', narratorPanHint:'右ドラッグ=移動 · Ctrl+スクロール=ズーム · ノードをドラッグで配置', narratorPickTarget:'接続先ノードをクリック', narratorLinkFilter:'リンクフィルター', description:'説明',
  ...
  ko: {
    ...
    writeBooks:'책', writeBookNew:'새 책', writeChapters:'챕터', writeChapterNew:'새 챕터', chapterLabel:'챕터 번호', exportDoc:'.doc로 내보내기',
    ...
    addDialogue:'다이얼로그 추가', conversation:'대화', addTalk:'대사 추가', speaker:'화자', edgeTool:'루트 연결', edgeLabel:'루트 라벨', narratorPanHint:'우클릭 드래그=이동 · Ctrl+스크롤=줌 · 노드 드래그로 배치', narratorPickTarget:'대상 노드를 클릭', narratorLinkFilter:'링크 필터', description:'설명',
  ...
  th: {
    ...
    writeBooks:'หนังสือ', writeBookNew:'เพิ่มหนังสือ', writeChapters:'ตอน', writeChapterNew:'เพิ่มตอน', chapterLabel:'เลขตอน', exportDoc:'ส่งออกเป็น .doc',
    ...
    addDialogue:'เพิ่ม Dialogue', conversation:'บทสนทนา', addTalk:'เพิ่มข้อความ', speaker:'ผู้พูด', edgeTool:'เชื่อมเส้นทาง', edgeLabel:'ป้ายเส้นทาง', narratorPanHint:'คลิกขวาค้างลาก = เลื่อน · Ctrl+Scroll = ซูม · ลาก node เพื่อจัดผัง', narratorPickTarget:'คลิก node ปลายทาง', narratorLinkFilter:'ตัวกรองลิงก์', description:'คำอธิบาย',
  ...
  zh: {
    ...
    writeBooks:'书籍', writeBookNew:'新建书籍', writeChapters:'章节', writeChapterNew:'新建章节', chapterLabel:'章节标签', exportDoc:'导出为 .doc',
    ...
    addDialogue:'添加对话', conversation:'会话', addTalk:'添加台词', speaker:'说话者', edgeTool:'连接路线', edgeLabel:'路线标签', narratorPanHint:'右键拖动=平移 · Ctrl+滚轮=缩放 · 拖动节点排列', narratorPickTarget:'点击目标节点', narratorLinkFilter:'链接过滤器', description:'描述',
  ...
  vi: {
    ...
    writeBooks:'Sách', writeBookNew:'Sách mới', writeChapters:'Chương', writeChapterNew:'Chương mới', chapterLabel:'Nhãn chương', exportDoc:'Xuất ra .doc',
    ...
    addDialogue:'Thêm Dialogue', conversation:'Hội thoại', addTalk:'Thêm lời thoại', speaker:'Người nói', edgeTool:'Nối tuyến', edgeLabel:'Nhãn tuyến', narratorPanHint:'Kéo chuột phải = di chuyển · Ctrl+Cuộn = thu phóng · kéo node để sắp xếp', narratorPickTarget:'Nhấp node đích', narratorLinkFilter:'Bộ lọc liên kết', description:'Mô tả',
  ...
  id: {
    ...
    writeBooks:'Buku', writeBookNew:'Buku baru', writeChapters:'Bab', writeChapterNew:'Bab baru', chapterLabel:'Label bab', exportDoc:'Ekspor sebagai .doc',
    ...
    addDialogue:'Tambah Dialog', conversation:'Percakapan', addTalk:'Tambah dialog', speaker:'Pembicara', edgeTool:'Hubungkan rute', edgeLabel:'Label rute', narratorPanHint:'Seret kanan = geser · Ctrl+Gulir = zoom · seret node untuk menata', narratorPickTarget:'Klik node tujuan', narratorLinkFilter:'Filter Tautan', description:'Deskripsi',
  ...
  es: {
    ...
    writeBooks:'Libros', writeBookNew:'Nuevo libro', writeChapters:'Capítulos', writeChapterNew:'Nuevo capítulo', chapterLabel:'Etiqueta de capítulo', exportDoc:'Exportar como .doc',
    ...
    addDialogue:'Añadir diálogo', conversation:'Conversación', addTalk:'Añadir línea', speaker:'Hablante', edgeTool:'Conectar ruta', edgeLabel:'Etiqueta de ruta', narratorPanHint:'Arrastre derecho = mover · Ctrl+Rueda = zoom · arrastre nodos', narratorPickTarget:'Haga clic en el nodo destino', narratorLinkFilter:'Filtro de enlaces', description:'Descripción',
  ...
  pt: {
    ...
    writeBooks:'Livros', writeBookNew:'Novo livro', writeChapters:'Capítulos', writeChapterNew:'Novo capítulo', chapterLabel:'Etiqueta do capítulo', exportDoc:'Exportar como .doc',
    ...
    addDialogue:'Adicionar diálogo', conversation:'Conversa', addTalk:'Adicionar fala', speaker:'Falante', edgeTool:'Conectar rota', edgeLabel:'Rótulo da rota', narratorPanHint:'Arrasto direito = mover · Ctrl+Rolagem = zoom · arraste nós', narratorPickTarget:'Clique no nó de destino', narratorLinkFilter:'Filtro de links', description:'Descrição',
  ...
  fr: {
    ...
    writeBooks:'Livres', writeBookNew:'Nouveau livre', writeChapters:'Chapitres', writeChapterNew:'Nouveau chapitre', chapterLabel:'Étiquette de chapitre', exportDoc:'Exporter en .doc',
    ...
    addDialogue:'Ajouter un dialogue', conversation:'Conversation', addTalk:'Ajouter une réplique', speaker:'Locuteur', edgeTool:'Relier la route', edgeLabel:'Étiquette de route', narratorPanHint:'Glisser droit = déplacer · Ctrl+Molette = zoom · glisser les nœuds', narratorPickTarget:'Cliquez le nœud cible', narratorLinkFilter:'Filtre de liens', description:'Description',
  ...
  de: {
    ...
    writeBooks:'Bücher', writeBookNew:'Neues Buch', writeChapters:'Kapitel', writeChapterNew:'Neues Kapitel', chapterLabel:'Kapitel-Label', exportDoc:'Als .doc exportieren',
  ...
  ru: {
    ...
    writeBooks:'Книги', writeBookNew:'Новая книга', writeChapters:'Главы', writeChapterNew:'Новая глава', chapterLabel:'Метка главы', exportDoc:'Экспорт в .doc',
    ...
    addDialogue:'Добавить диалог', conversation:'Разговор', addTalk:'Добавить реплику', speaker:'Говорящий', edgeTool:'Соединить маршрут', edgeLabel:'Метка маршрута', narratorPanHint:'Правая кнопка = панорама · Ctrl+Колесо = масштаб · перетаскивайте узлы', narratorPickTarget:'Нажмите целевой узел', narratorLinkFilter:'Фильтр ссылок', description:'Описание',
  ...
  it: {
    ...
    writeBooks:'Libri', writeBookNew:'Nuovo libro', writeChapters:'Capitoli', writeChapterNew:'Nuovo capitolo', chapterLabel:'Etichetta capitolo', exportDoc:'Esporta come .doc',
    ...
    addDialogue:'Aggiungi dialogo', conversation:'Conversazione', addTalk:'Aggiungi battuta', speaker:'Parlante', edgeTool:'Collega percorso', edgeLabel:'Etichetta percorso', narratorPanHint:'Trascina col destro = sposta · Ctrl+Rotella = zoom · trascina i nodi', narratorPickTarget:'Clicca il nodo di destinazione', narratorLinkFilter:'Filtro link', description:'Descrizione',
  ...
  nl: {
    ...
    writeBooks:'Boeken', writeBookNew:'Nieuw boek', writeChapters:'Hoofdstukken', writeChapterNew:'Nieuw hoofdstuk', chapterLabel:'Hoofdstuklabel', exportDoc:'Exporteren als .doc',
  ...
  pl: {
    ...
    writeBooks:'Książki', writeBookNew:'Nowa książka', writeChapters:'Rozdziały', writeChapterNew:'Nowy rozdział', chapterLabel:'Etykieta rozdziału', exportDoc:'Eksportuj jako .doc',
    ...
    addDialogue:'Dodaj dialog', conversation:'Rozmowa', addTalk:'Dodaj kwestię', speaker:'Mówca', edgeTool:'Połącz trasę', edgeLabel:'Etykieta trasy', narratorPanHint:'Przeciągnij prawym = przesuń · Ctrl+Kółko = zoom · przeciągaj węzły', narratorPickTarget:'Kliknij węzeł docelowy', narratorLinkFilter:'Filtr linków', description:'Opis',
  ...
  uk: {
    ...
    writeBooks:'Книги', writeBookNew:'Нова книга', writeChapters:'Розділи', writeChapterNew:'Новий розділ', chapterLabel:'Мітка розділу', exportDoc:'Експорт у .doc',
    ...
    addDialogue:'Додати діалог', conversation:'Розмова', addTalk:'Додати репліку', speaker:'Мовець', edgeTool:'З\'єднати маршрут', edgeLabel:'Мітка маршруту', narratorPanHint:'Права кнопка = панорама · Ctrl+Колесо = масштаб · перетягуйте вузли', narratorPickTarget:'Натисніть цільовий вузол', narratorLinkFilter:'Фільтр посилань', description:'Опис',
  ...
  tr: {
    ...
    writeBooks:'Kitaplar', writeBookNew:'Yeni kitap', writeChapters:'Bölümler', writeChapterNew:'Yeni bölüm', chapterLabel:'Bölüm etiketi', exportDoc:'.doc olarak dışa aktar',
    ...
    addDialogue:'Diyalog ekle', conversation:'Konuşma', addTalk:'Satır ekle', speaker:'Konuşan', edgeTool:'Rota bağla', edgeLabel:'Rota etiketi', narratorPanHint:'Sağ sürükle = kaydır · Ctrl+Tekerlek = yakınlaştır · düğümleri sürükle', narratorPickTarget:'Hedef düğüme tıkla', narratorLinkFilter:'Bağlantı filtresi', description:'Açıklama',
  ...
  qd: {
    ...
    writeBooks:'Tomyx', writeBookNew:'Esshka Tomyx', writeChapters:'Versethra', writeChapterNew:'Esshka Versethra', chapterLabel:'Versethra Laybel', exportDoc:'Exportyth as .doc',
    ...
    addDialogue:'Adde Dialogye', conversation:'Conversathe', addTalk:'Adde lyne', speaker:'Spekker', edgeTool:'Connecte rowte', edgeLabel:'Rowte laybel', narratorPanHint:'Ryght-drag = pan · Ctrl+Scrowl = zoome · drag noddes', narratorPickTarget:'Clycke the target nodde', narratorLinkFilter:'Lynke Fylterr', description:'Loretelling',
